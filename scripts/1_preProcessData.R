...
# Thank you and please cite our work if you use our data in your project.
...
load10x(din = "./inputNoIntrons2/", dout = "./output/s1/", outName = "230403_NoIntrons", testQC = F, nFeature_RNA_high = 3000, nFeature_RNA_low = 200, percent.mt_high = 80, nCount_RNA_high = 25000, nCount_RNA_low = 100)
...
#ID non0duodenal cells to complete secondary pct.mt filter
